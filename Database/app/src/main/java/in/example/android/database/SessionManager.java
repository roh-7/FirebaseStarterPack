...
import static in.example.android.database.Constants.IS_LOGIN;
import static in.example.android.database.Constants.PROFILE_URL;
import static in.example.android.database.Constants.USER_EMAIL;
import static in.example.android.database.Constants.USER_NAME;
